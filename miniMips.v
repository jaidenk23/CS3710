...
// ECE3710 - Mini MIPS
//
// Module Name:   C:\intelFPGA_lite\18.1\quartus\3710_lab\miniMips\miniMips.v
...
module controller(input            clk, reset, 
	...
	// Parameters for state names and instruction types
    ...
    parameter ADDIEX  =  4'b1110;  // State for ADDI Execute
    parameter ADDIWR  =  4'b1111;  // State for ADDI Write-back
        ...
        case(state)
            ...
            DECODE:  
                case(op)
                    ...
                    BEQ:     nextstate <= BEQEX;
                    J:       nextstate <= JEX;
                    ADDI:    nextstate <= ADDIEX;  // Decoding ADDI
            ...
            ADDIEX:  nextstate <= ADDIWR;  // Execution state for ADDI
            ADDIWR:  nextstate <= FETCH1;  // Write-back state for ADDI
            default: nextstate <= FETCH1;
        endcase
    end
            ...
            case(state)
               ...
               JEX:
                  begin
					...
					ADDIEX:
						begin
							alusrca <= 1;        // Source A from register
							alusrcb <= 2'b11;   // Source B from instruction immediate
...
module regfile #(parameter WIDTH = 8, REGBITS = 3)
   ...
   reg  [WIDTH-1:0] RAM [(1<<REGBITS)-1:0];
	...
	$readmemb("C:\\intelFPGA_lite\\18.1\\quartus\\3710_lab\\miniMips\\reg.dat", RAM); 
